...
#hist(dwh$diff_56_0)
qplot(dwh$diff_56_0, xlab="Différence de score entre J56 et J0", fill=I("grey80"), col=I("darkblue"),bins=10)
...
geom_boxplot(width = 0.5, fill = "lightsteelblue2", color = "lightsteelblue4") +
...
qplot(resid(mod2), xlab="résidus du modèle mixte mod2", binwidth=2)
```
...
g <- ggsurv(KMcurv, surv.col=c("skyblue", "royalblue"),size.est=1,cens.col="black") + 
